...
void mpedit( CHAR_DATA *ch, char *argument)
{
    ...
    {
		ch->send("You exit MP_Edit.\n\r");
		act("$n exits MP_Edit.",ch,NULL,NULL,TO_ROOM);
        edit_done(ch);
        return;
    }
...
void opedit( CHAR_DATA *ch, char *argument)
{
    ...
    if (!str_cmp(command, "done") )
    {
		ch->send("You exit OP_Edit.\n\r");
		act("$n exits OP_Edit.",ch,NULL,NULL,TO_ROOM);
        edit_done(ch);
        return;
    }
...
void rpedit( CHAR_DATA *ch, char *argument)
{
    ...
    if (!str_cmp(command, "done") )
    {
		ch->send("You exit RP_Edit.\n\r");
		act("$n exits RP_Edit.",ch,NULL,NULL,TO_ROOM);
        edit_done(ch);
        return;
    }
...
void do_mpedit(CHAR_DATA *ch, char *argument)
{
    ...
    if( is_number(command) )
    {
		...
		ch->send("You enter MP_Edit.\n\r");
		act("$n enters MP_Edit.",ch,NULL,NULL,TO_ROOM);
...
void do_opedit(CHAR_DATA *ch, char *argument)
{
    ...
    if( is_number(command) )
    {
		...
		ch->send("You enter OP_Edit.\n\r");
		act("$n enters OP_Edit.",ch,NULL,NULL,TO_ROOM);
...
void do_rpedit(CHAR_DATA *ch, char *argument)
{
    ...
    if( is_number(command) )
    {
		...
		ch->send("You enter RP_Edit.\n\r");
		act("$n enters RP_Edit.",ch,NULL,NULL,TO_ROOM);
...
MPEDIT (mpedit_create)
{
    ...
    send_to_char("MobProgram Code Created. You enter MP_Edit.\n\r",ch);
	act("$n enters MP_Edit.",ch,NULL,NULL,TO_ROOM);
...
OPEDIT (opedit_create)
{
    ...
    send_to_char("ObjProgram Code Created. You enter OP_Edit.\n\r",ch);
	act("$n enters OP_Edit.",ch,NULL,NULL,TO_ROOM);
...
RPEDIT (rpedit_create)
{
    ...
    send_to_char("RoomProgram Code Created. You enter RP_Edit.\n\r",ch);
	act("$n enters RP_Edit.",ch,NULL,NULL,TO_ROOM);
