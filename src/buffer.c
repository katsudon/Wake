#include <stdarg.h>
#include <stdlib.h>
#include "merc.h" /* This should be replaced with "merc.h" and a few others 
                      * I just include all the essential include files in include.h 
                      */
...

{
	...
	buffer = (BUFFER2*)alloc_mem(sizeof(BUFFER2));
